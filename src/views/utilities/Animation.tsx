            ...
            <Grid item xs={12}>
              <Grid container spacing={3}>
                <Grid item sm={12} md={4}>
                  <SubCard
                    title="Animation"
                    sx={{ "& .MuiButton-root": { mr: 2, mb: 2 } }}
                  >
                    <Button
                      variant={type === "grow" ? "contained" : "outlined"}
                      onClick={() => setType("grow")}
                    >
                      Grow
                    </Button>
                    <Button
                    ...
                    <Button
                      variant={type === "fade" ? "contained" : "outlined"}
                      onClick={() => setType("fade")}
                    >
                      Fade
                    </Button>
                    <Button
                      variant={type === "slide" ? "contained" : "outlined"}
                      onClick={() => setType("slide")}
                    >
                      Slide
                    </Button>
                    <Button
                      variant={type === "zoom" ? "contained" : "outlined"}
                ...
                <Grid item sm={12} md={4}>
                  <SubCard
                    title="Position (Grow & Zoom Animation)"
                    sx={{ "& .MuiButton-root": { mr: 2, mb: 2 } }}
                  >
                    <Button
                      variant={
                        position === "top-left" ? "contained" : "outlined"
                      }
                    ...
                    <Button
                      variant={
                        position === "top-right" ? "contained" : "outlined"
                      }
                    ...
                    <Button
                      variant={
                        position === "bottom-left" ? "contained" : "outlined"
                      }
                    ...
                    <Button
                      variant={
                        position === "bottom-right" ? "contained" : "outlined"
                      }
                ...
                <Grid item sm={12} md={4}>
                  <SubCard
                    title="Direction (Slide Animation)"
                    sx={{ "& .MuiButton-root": { mr: 2, mb: 2 } }}
                  >
                    <Button
              ...
              <Stack spacing={3} alignItems="center">
                <Box>
                  <Stack direction="row" spacing={1} alignItems="center">
                    <Typography variant={animate ? "h5" : "body1"}>
                      IN
                    </Typography>
                    <Switch
                      checked={animate}
