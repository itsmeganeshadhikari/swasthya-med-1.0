...
const AddAddress = ({
  ...
  const formik = useFormik({
    ...
    initialValues: {
      ...
      name: edit ? address.name : "Sunsari,ward-15,Dasarathpath",
    ...
    onSubmit: (values: UserAddress) => {
      ...
      // window.location.reload(); //Page not update due product.map is not a function
    },
  });
          ...
          <Grid container spacing={gridSpacing}>
            ...
            {/* <Grid item xs={6}>
              <TextField
                ...
                onChange={formik.handleChange}
                error={
                  formik.touched.building && Boolean(formik.errors.country)
                }
