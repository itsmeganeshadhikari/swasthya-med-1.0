...
const filter: (
  options: FilmFilter[],
  state: FilterOptionsState<FilmFilter>
) => FilmFilter[] = createFilterOptions();
...
const FrmAutocomplete = () => {
  const [valueControl, setValueControl] = React.useState<
    FilmFilter | null | undefined
  >(null);
  const [value, setValue] = React.useState<string>(options[0]);
  const [inputValue, setInputValue] = React.useState<string>("");
  const [value2, setValue2] = React.useState<
    string | FilmFilter | null | undefined
  >(options[0]);

  const defaultProps = {
    options: top100Films,
    getOptionLabel: (option: FilmFilter) => option.title,
  };
  ...
  return (
    <MainCard
      title="Autocomplete"
      secondary={
        <SecondaryAction link="https://next.material-ui.com/components/autocomplete/" />
      }
    >
            ...
            <Grid item xs={12}>
              <SubCard title="Free Solo">
                <Autocomplete
                  ...
                  options={top100Films.map((option) => option.title)}
                  renderInput={(params) => (
                    <TextField {...params} label="Free Solo" margin="normal" />
                  )}
                />
              </SubCard>
            </Grid>
              ...
              <SubCard title="Creatable">
                <Autocomplete
                  ...
                  onChange={(
                    ...
                    newValue: string | FilmFilter | null | undefined
                  ) => {
                  ...
                  options={top100Films}
                  getOptionLabel={(option: FilmFilter) => {
            ...
            <Grid container direction="column" spacing={2}>
              ...
              <Grid item xs={12}>
                <Autocomplete
                  ...
                  onChange={(
                    event,
                    newValue: FilmFilter | null | undefined
                  ) => {
