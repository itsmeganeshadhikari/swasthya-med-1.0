...
export const columnsOrder: string[] = [
  columnIds.column1,
  columnIds.column2,
  columnIds.column3,
  columnIds.column4,
...
export const userStoryOrder: string[] = [
  userStoryIds.userStory1,
  userStoryIds.userStory2,
  userStoryIds.userStory3,
  userStoryIds.userStory4,
];

export const userStory: KanbanUserStory[] = [
  {
    acceptance: "",
    assign: profileIds.profile2,
